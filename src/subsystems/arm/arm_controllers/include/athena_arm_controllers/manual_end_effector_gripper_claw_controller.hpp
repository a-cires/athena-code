#ifndef ATHENA_ARM_CONTROLLERS__MANUAL_END_EFFECTOR_GRIPPER_CLAW_CONTROLLER_HPP_
#define ATHENA_ARM_CONTROLLERS__MANUAL_END_EFFECTOR_GRIPPER_CLAW_CONTROLLER_HPP_
...
#include <arm_controllers/manual_end_effector_gripper_claw_controller_parameters.hpp>
...
class ManualEndEffectorGripperClawController : public controller_interface::ControllerInterface
{
public:
  ATHENA_ARM_CONTROLLERS__VISIBILITY_PUBLIC
  ManualEndEffectorGripperClawController();
...
protected:
  std::shared_ptr<manual_end_effector_gripper_claw_controller::ParamListener> param_listener_;
  manual_end_effector_gripper_claw_controller::Params params_;
...
#endif  // ATHENA_ARM_CONTROLLERS__MANUAL_END_EFFECTOR_GRIPPER_CLAW_CONTROLLER_HPP_
