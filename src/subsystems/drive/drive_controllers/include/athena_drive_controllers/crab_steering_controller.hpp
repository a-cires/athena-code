...
#ifndef ATHENA_DRIVE_CONTROLLERS__CRAB_STEERING_CONTROLLER_HPP_
#define ATHENA_DRIVE_CONTROLLERS__CRAB_STEERING_CONTROLLER_HPP_
...
#include <drive_controllers/crab_steering_controller_parameters.hpp>
...
class CrabSteeringController : public controller_interface::ControllerInterface
{
public:
  ATHENA_DRIVE_CONTROLLERS__VISIBILITY_PUBLIC
  CrabSteeringController();
...
protected:
  std::shared_ptr<crab_steering_controller::ParamListener> param_listener_;
  crab_steering_controller::Params params_;

  std::vector<std::string> joints;
  std::vector<std::string> drive_joints;
  std::vector<std::string> swerve_joints;
...
#endif  // ATHENA_DRIVE_CONTROLLERS__CRAB_STEERING_CONTROLLER_HPP_
